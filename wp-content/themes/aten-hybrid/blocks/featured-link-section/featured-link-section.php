			...
			<ul class="sections">
				...
				<li class="featured-link-section featured-link-section-<?php echo $section_count; ?>">
					...
					<div class="title-pane">
						...
						<div class="title-wrapper">
							...
							<div class="desktop-title">
								...
								<?php // Looping through button links, up to 2 allowed
					...
					<div class="link-pane">
						...
						<?php // Looping through list of links
						if( have_rows('listed_links') ): ?>
							<ul class="listed-links">
							<?php while( have_rows('listed_links') ) : the_row(); 
							...
							?>
								<li>
									...
									<a href="<?php echo $link['url']; ?>" title="<?php echo $link['title']; ?>" target="<?php echo $link_target; ?>">
										<?php echo $link_title; 
										if( $link_target === '_blank' ) { ?> <span class="link-icon external-link notranslate" aria-hidden="true">open_in_new</span> <?php } ?>
									</a>
								</li>
