...
if (have_rows('accordion_panels')) : ?>
    ...
    <?php while (have_rows('accordion_panels')) :
      the_row();
      // Get panel label.
      ...
      ?>
          ...
          <?php elseif ($video_source === 'link' && $video_link) :
            echo $video_link;
            // Video source type                                     endif;.
            ?>

                                <?php
                                // Flexible Content endif;.
                                ?>

                            <?php
                            // Panel Content Loop.
                          endwhile;
                          // Panel Content Loop.                         endif;.
                          ?>
                    </div>
                </div>
            </div>
                          <?php
                          // Accordion Panels loop endwhile;.
                          ?>

        </div>
                          <?php
                          // Accordion Panels loop.
                        endif;
