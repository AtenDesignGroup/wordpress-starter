...
$archive_slug = get_post_type_object( 'message' )->has_archive;
$message_custom_fields = get_field('message_lab_archive', 'option');
$archive_title = ($message_custom_fields && $message_custom_fields['message_lab_title']) ? $message_custom_fields['message_lab_title'] : 'Message Lab';
