 ...
 *          or the post ID of the post hostßing this block.
					...
					if ( $location_title || $location_link || $phone || $address || $hours_of_operation || $info ) :
						...
						<li class="location-item">
							...
							<div class="location-information">
								<h2 class="location-block-title"><a href="<?php echo esc_url( $location_link ); ?>"><?php echo esc_html( $location_title ); ?></a></h2>
							...
							">
								...
								elseif ( ! $image ) :
									?>
									<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/icons/location_default.svg" alt="<?php echo esc_attr( $location_title ); ?>" />
								<?php endif; ?>
							</div>
						</li>
