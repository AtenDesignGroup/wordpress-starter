...
if ( isset( $block['data']['preview_image'] ) ) :    /* rendering in inserter preview  */
	...
	$location_post = get_field( 'event_location', get_the_ID() );
	if ( $location_post ) :
		...
		<div <?php echo esc_attr( $anchor ); ?> class="<?php echo esc_attr( $class_name ); ?>">
			<div class="locations-block-component">
				<?php
					// Output the location post in the style of the Locations block.
				...
				if ( $location_title || $location_link || $phone || $address || $hours_of_operation || $info ) :
					...
					<li class="location-item">
						...
						<div class="location-information">
							<h2 class="location-block-title"><a href="<?php echo esc_html( $location_link ); ?>"><?php echo esc_html( $location_title ); ?></a></h2>
							<ul class="location-details">
								...
								if ( $address || $city || $zip ) :
									...
									<li class="location-address">
										...
										<?php if ( $maps_link ) { ?>
											<a href="<?php echo esc_attr( $maps_link ); ?>" target="_blank" title="Get directions">
										<?php } ?>
								...
								if ( is_array( $hours_of_operation ) ) :
									...
									<li class="location-hours">
										...
										<?php
										foreach ( $hours_of_operation as $hours_entry ) {
						...
						">
							...
							elseif ( ! $image ) :
								?>
								<img src="/assets/icons/location_default.svg" alt="<?php echo esc_attr( $location_title ); ?>" />
							<?php endif; ?>
						</div>
					</li>
