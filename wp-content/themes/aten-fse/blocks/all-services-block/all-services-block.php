	...
	if( have_rows('services_sections') ): ?>
		...
		<div <?php echo $anchor; ?>class="<?php echo esc_attr( $class_name ); ?> l-gutter">
			...
			<ul class="section-list">
				...
				<?php 
				$color_counter = 1; // Counter to determine section card colors
						...
						<?php if( have_rows('services') ): ?>
							<ul class="service-cards">
								<?php while( have_rows('services') ): the_row(); 
									...
									$description = get_sub_field('service_description'); // Optional
								?>
			...
			endwhile; // While Services sections ?>
