 ...
 * Version: 1.0
 *
 * @package PantheonMUPluginLoader
 */
...
add_action(
	...
	function () use ( $pantheon_mu_plugins ) {
...
add_filter(
	...
	function ( $actions, $plugin_file, $plugin_data, $context ) use ( $pantheon_mu_plugins ) {
		if ( 'mustuse' !== $context || ! in_array( $plugin_file, $pantheon_mu_plugins, true ) ) {
			return $actions;
		}
