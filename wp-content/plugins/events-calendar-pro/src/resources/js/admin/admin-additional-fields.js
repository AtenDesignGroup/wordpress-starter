var tribe = typeof tribe === "object" ? tribe : {}; tribe["events-pro"] = tribe["events-pro"] || {}; tribe["events-pro"]["admin-additional-fields"] =
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "attachBehavior", function() { return attachBehavior; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "init", function() { return init; });
const toggleInput = (input, isActive) => {
...
const attachBehavior = isCreatingFields => button => {
  if (button._attached) {
    return;
  }
...
const init = isCreatingFields => () => {
  [].slice.call(document.querySelectorAll('.tribe-custom-field-gutenberg-checkbox')).map(attachBehavior(isCreatingFields));
};
