...
?>
<em
	class="tribe-events-pro-week-grid__multiday-event-hidden-featured-icon"
	title="<?php esc_attr_e( 'Featured', 'tribe-events-calendar-pro' ); ?>"
>
	<?php $this->template( 'components/icons/featured', [ 'classes' => [ 'tribe-events-pro-week-grid__multiday-event-hidden-featured-icon-svg' ] ] ); ?>
</em>
