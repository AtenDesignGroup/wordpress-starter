...
/**
 * Class Month_Calendar_Event_Recurring_Icon
 *
 * @since   4.7.8
 * @package Tribe\Events\Pro\Views\V2\Views\Partials
 */
class Month_Calendar_Event_Multiday_Recurring_Icon implements View_Partial_Interface {
	/**
	...
	public function render( \Tribe__Template $template ) {
		return $template->template( 'month/calendar-event/multiday/recurring', $template->get_values() );
	}
}
