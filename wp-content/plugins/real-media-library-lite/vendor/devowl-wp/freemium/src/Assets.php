...
trait Assets
{
    ...
    public function localizeFreemiumScript()
    {
         ...
         */
        $core = $base->getCore();
        return ['isPro' => $freemium->isPro(), 'showProHints' => \current_user_can('activate_plugins') && !$freemium->isPro(), 'proUrl' => $base->getPluginConstant(Constants::PLUGIN_CONST_PRO_VERSION), 'showLiteNotice' => !$core->isLiteNoticeDismissed()];
    }
}
