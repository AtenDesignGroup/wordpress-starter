...
class CrossSellingHandler
{
    ...
    const ALL_VERSIONS = [
        ...
        CrossRealCategoryLibrary::FILE_PRO,
        CrossRealPhysicalMedia::FILE_PRO,
        CrossRealMediaLibrary::FILE_PRO,
        CrossRealCookieBanner::FILE_PRO,
        // Lite versions
        'real-thumbnail-generator-lite/index.php',
        CrossRealCategoryLibrary::FILE_LITE,
        CrossRealMediaLibrary::FILE_LITE,
        CrossRealCookieBanner::FILE_LITE,
    ];
    const PRO_VERSIONS = ['real-thumbnail-generator/index.php', CrossRealCategoryLibrary::FILE_PRO, CrossRealPhysicalMedia::FILE_PRO, CrossRealMediaLibrary::FILE_PRO, CrossRealCookieBanner::FILE_PRO];
    /**
     * C'tor.
     *
     * @codeCoverageIgnore
    ...
    public function getAvailable()
    {
        ...
        $result = [];
        foreach (\array_values(Core::getInstance()->getCrossSellings()) as $product) {
            if (!$product->skip()) {
    ...
    {
        return new CrossSellingHandler();
    }
}
