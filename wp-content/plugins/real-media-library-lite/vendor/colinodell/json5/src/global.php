...
if (!\function_exists('MatthiasWeb\\RealMediaLibrary\\Vendor\\json5_decode')) {
    /**
    ...
    {
        return \MatthiasWeb\RealMediaLibrary\Vendor\ColinODell\Json5\Json5Decoder::decode($source, $associative, $depth, $options);
    }
}
// PHP 7.3 polyfills
