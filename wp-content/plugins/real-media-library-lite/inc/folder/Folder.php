...
class Folder extends Sortable
{
    ...
    {
        return new \MatthiasWeb\RealMediaLibrary\folder\Folder($rowData->id, $rowData->parent, $rowData->name, $rowData->slug, $rowData->absolute, $rowData->ord, $rowData->cnt_result, $rowData);
    }
    // Documented in Creatable
